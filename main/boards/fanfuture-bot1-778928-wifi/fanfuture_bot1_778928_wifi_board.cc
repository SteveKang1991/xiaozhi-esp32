...
#define TAG "FanFutureBot1778928WiFiBoard"

class FanFutureBot1778928WiFiBoard : public WifiBoard {
private:
...
DECLARE_BOARD(FanFutureBot1778928WiFiBoard);
