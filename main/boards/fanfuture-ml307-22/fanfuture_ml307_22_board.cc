...
#include "../fanfuture-wifi-22/power_manager.h"
#include "../fanfuture-wifi-22/lightam_controller.h"
...
#define TAG "FanFutureML30722Board"

LV_FONT_DECLARE(font_puhui_16_4);
LV_FONT_DECLARE(font_awesome_16_4);

class FanFutureML30722Board : public DualNetworkBoard {
private:
    ...
    void InitializeButtons() {
        ...
        volume_up_button_.OnLongPress([this]() {
            power_save_timer_->WakeUp();
            GetAudioCodec()->SetOutputVolume(200);
...
DECLARE_BOARD(FanFutureML30722Board);
