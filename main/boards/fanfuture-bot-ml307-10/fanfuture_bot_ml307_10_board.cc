...
#include "../fanfuture-bot-wifi-10/power_manager.h"
#include "../fanfuture-bot-wifi-10/lightam_controller.h"
...
#define TAG "FanFutureBotML30710Board"
...
class FanFutureBotML30710Board : public DualNetworkBoard {
private:
...
DECLARE_BOARD(FanFutureBotML30710Board);
