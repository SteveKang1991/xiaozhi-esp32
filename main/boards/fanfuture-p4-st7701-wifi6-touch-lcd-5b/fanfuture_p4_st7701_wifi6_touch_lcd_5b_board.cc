...
#define TAG "FanFutureP4ST7701WiFi6TouchLcd5BBoard"

class FanFutureP4ST7701WiFi6TouchLcd5BBoard : public WifiBoard {
private:
...
DECLARE_BOARD(FanFutureP4ST7701WiFi6TouchLcd5BBoard);
