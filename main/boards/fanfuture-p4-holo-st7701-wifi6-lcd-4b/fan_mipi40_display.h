#ifndef FAN_MIPI40_DISPLAY_H
#define FAN_MIPI40_DISPLAY_H
...
#define FAN_MIPI50_DISPLAY_TAG "FanMIPI40Display"
...
// FAN MIPI 4.0寸显示器
class FanMIPI40Display : public LcdDisplay {
public:
    FanMIPI40Display(esp_lcd_panel_io_handle_t panel_io, esp_lcd_panel_handle_t panel,
    ...
    virtual void SetRoleAnimation(const char* state) override {
        ...
        ESP_LOGI(FAN_MIPI50_DISPLAY_TAG, "SetRoleAnimation clip=%s", clip);
