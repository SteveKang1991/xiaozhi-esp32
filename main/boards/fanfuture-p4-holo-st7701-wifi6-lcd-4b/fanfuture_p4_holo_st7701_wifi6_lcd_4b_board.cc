...
#define TAG "FanFutureP4HoloST7701WiFi6Lcd4BBoard"

class FanFutureP4HoloST7701WiFi6Lcd4BBoard : public WifiBoard {
private:
    ...
    void InitializeLCD() {
        ...
        const esp_lcd_panel_dev_config_t lcd_dev_config = {
            ...
            .rgb_ele_order = LCD_RGB_ELEMENT_ORDER_BGR,  // BGR顺序
            .bits_per_pixel = 16,
        ...
        display_ = new FanMIPI40Display(io, disp_panel, DISPLAY_WIDTH, DISPLAY_HEIGHT, DISPLAY_OFFSET_X,
...
public:
    FanFutureP4HoloST7701WiFi6Lcd4BBoard() :
        WifiBoard(),
...
DECLARE_BOARD(FanFutureP4HoloST7701WiFi6Lcd4BBoard);
