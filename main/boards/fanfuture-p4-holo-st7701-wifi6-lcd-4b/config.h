...
// ST7701 初始化序列 - 使用UT040BWV126NC厂家提供的序列
static const st7701_lcd_init_cmd_t st7701_init_cmds[] = {
    ...
    {0xB0, (uint8_t[]){0x80, 0x13, 0x5A, 0x10, 0x13, 0x07, 0x0B, 0x0A, 0x08, 0x25, 0x05, 0x12, 0x0F, 0x79, 0x7D, 0x4F}, 16, 0},
    {0xB1, (uint8_t[]){0x40, 0x0B, 0x55, 0x0C, 0x90, 0x06, 0x08, 0x07, 0x07, 0x24, 0x02, 0x11, 0x11, 0xF9, 0x7D, 0x4F}, 16, 0},
    {0xFF, (uint8_t[]){0x77, 0x01, 0x00, 0x00, 0x11}, 5, 0},
    {0xB0, (uint8_t[]){0x5D}, 1, 0},
    {0xB1, (uint8_t[]){0x21}, 1, 0},
    ...
    {0x3A, (uint8_t[]){0x05}, 1, 0},  // COLMOD: RGB565 (0x05 = VIPF[2:0]=101)
    {0x36, (uint8_t[]){0x00}, 1, 0},  // MADCTL: RGB顺序
