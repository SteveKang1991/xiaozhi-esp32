...
#include "../fanfuture-speaker-s6-wifi/power_manager.h"
#include "../fanfuture-speaker-s6-wifi/lightam_controller.h"
#include "../fanfuture-speaker-s6-wifi/fan_lcd20_display.h"
...
#define TAG "FanFutureSpeakerS6ML307Board"
...
class FanFutureSpeakerS6ML307Board : public DualNetworkBoard {
private:
...
DECLARE_BOARD(FanFutureSpeakerS6ML307Board);
