...
#define TAG "FanFutureP4ILI9881WiFiBoard"

class FanFutureP4ILI9881WiFiBoard : public WifiBoard {
private:
...
DECLARE_BOARD(FanFutureP4ILI9881WiFiBoard);
