...
#include "../fanfuture-bot-r1-wifi/power_manager.h"
#include "../fanfuture-bot-r1-wifi/lightam_controller.h"
#include "../fanfuture-bot-r1-wifi/fan_lcd35_display.h"
...
#define TAG "FanFutureBotR1ML307Board"
...
class FanFutureBotR1ML307Board : public DualNetworkBoard {
private:
...
DECLARE_BOARD(FanFutureBotR1ML307Board);
