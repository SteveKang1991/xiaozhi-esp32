 ...
 * Size: 120 px
 * Bpp: 4
 * Alibaba PuHuiTi 3.0 95 ExtraBold, digits 0-9
 * Opts: --bpp 4 --size 120 --no-compress --no-kerning --font AlibabaPuHuiTi-3-95-ExtraBold.ttf --symbols 0123456789 --format lvgl --lv-font-name font_puhui_number_120_4
 ******************************************************************************/
